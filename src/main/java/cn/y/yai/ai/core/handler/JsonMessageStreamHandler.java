...
import cn.y.yai.ai.model.message.*;
import cn.y.yai.ai.tools.BaseTool;
...
public class JsonMessageStreamHandler {
    ...
    /**
     * 处理 TokenStream(Vue_Project) 流式消息
     * 解析 JSON 消息并重组为完整的响应格式
     *
     * @param originFlux 原始流式消息
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnError(error -> {
                    ...
                    chatHistoryService.addChatMessage(appId, errorMessage, ChatMessageTypeEnum.ERROR.getValue(), loginUser.getId());
                });
    }
