...
import cn.y.yai.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory> implements ChatHistoryService {
    ...
    public QueryWrapper getQueryWrapper(ChatHistoryQueryRequest chatHistoryQueryRequest) {
        ...
        LocalDateTime lastCreateTime = chatHistoryQueryRequest.getLocalDateTime();
    ...
    public boolean addChatMessage(Long appId, String message, String messageType, Long userId) {
        ...
        // 验证消息类型是否有效
        ChatMessageTypeEnum messageTypeEnum = ChatMessageTypeEnum.getEnumByValue(messageType);
    ...
    public Page<ChatHistory> listAppChatHistoryByPage(Long appId, int pageSize, LocalDateTime lastCreateTime, User loginUser) {
        ...
        ThrowUtils.throwIf(!isCreator && !isAdmin, ErrorCode.NO_AUTH_ERROR, "无权限查看该应用的历史对话");
        // 构建查询条件
        ChatHistoryQueryRequest chatHistoryQueryRequest = new ChatHistoryQueryRequest();
        chatHistoryQueryRequest.setAppId(appId);
        chatHistoryQueryRequest.setLocalDateTime(lastCreateTime);
